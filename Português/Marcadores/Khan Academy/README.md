# Hacks da Khan Academy


## Tutorial (Geral)

1) Arraste e solte o código na sua barra de favoritos
2) Entre na Khan Academy e active o código
3) Aproveite!
...
O Answer Overwrite responde às perguntas da lição da Khan Academy e é uma maneira eficiente de concluir as tarefas na Khan sem fazer isso

### Ponto de Energia Agricultor
```js
...
O agricultor é uma forma eficiente de obter pontos de energia, por isso, se quiseres obter pontos de energia, esta é a estratégia!

Esta estratégia tem apenas 50% de hipóteses de funcionar

## Seguro?

Sim, isto é seguro, não houve **zero** casos registados de uma conta Khan ser banida por hacks (pelo menos por agora). Além disso, se estás a perguntar se isto é um vírus, é 100% open-sourced para sempre, por isso podes olhar para o código para veres por ti próprio.

## Apoie-nos

Por favor, junte-se ao nosso Discord em discord.gg/khanacademy 

Fazemos regularmente hacks que as pessoas no nosso discord escolhem, e tu podes juntar-te a eles!
