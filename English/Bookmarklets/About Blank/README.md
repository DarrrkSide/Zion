...
It access a page where you can enter links that turns the page into a about:blank so it doesn't go on your screen time and teachers can't view it

## Safe?

This is a 100% open-sourced project
